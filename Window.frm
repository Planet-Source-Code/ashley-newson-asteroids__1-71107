...
Private Sub About_Click()
    MsgBox ("Asteroids V1.4.0 By Ashley Newson (C) Ashley Newson 2008")
End Sub
...
Private Sub Form_Load()
    Label1.Caption = Form1.Width - Screen.Width
    Label2.Caption = Form1.Height - Screen.Height
    Randomize Timer
    ship(3) = 255
    ...
    For i& = 1 To 64
        ...
        asteroids(i&, 6) = 5
    Next
    MsgBox ("Loading Complete! Click OK then press ''P'' or ''Pause Break'' to play!" + Chr$(13) + "Mouse: Aim/Turn" + Chr$(13) + "Left Mouse: Fire Bullets" + Chr$(13) + "Right Mouse: Thrust On" + Chr$(13) + "Space: Drop Bomb" + Chr$(13) + "Ctrl/Alt: Fire Rocket" + Chr$(13) + "Esc: Exit Fullscreen" + Chr$(13) + "F11: Toggle Fullscreen")
End Sub

Private Sub Form_resize()
    If Form1.WindowState <> 1 Then
        Screen.Cls
        Screen.Width = Form1.Width - Val(Label1.Caption)
        Screen.Height = Form1.Height - Val(Label2.Caption)
...
Private Sub Full_Click()
    ...
    Form3.Timer1.Interval = Timer1.Interval
End Sub

Private Sub FullKey_Click()
    Load Form3
    Form3.Show
    Form3.WindowState = 2
    Timer1.Enabled = False
...
Private Sub License_Click()
    MsgBox ("Asteroids V1.4.0 (C) Ashley Newson 2008 Freeware License" + Chr$(13) + "By using this program in any way you are automatically agreeing to this license agreement:" + Chr$(13) + "1. You may not sell this product or any individual part of it, yet you are permitted to distribute for free." + Chr$(13) + "2. You are allowed to edit the source code to make your own adaption of this product BUT you must make clear the original author's name (Ashley Newson). You are allowed to use the source code as an example and you will not need to state the original author's name if used just as an example." + Chr$(13) + "3. Adaptions must be released under the same license. If you wish to change the license contact the original author (master0060@hotmail.co.uk)." + Chr$(13) + "4. The original author is not liable to legal damage if this program (original or adaptation) goes wrong or any damage occours while being used.")
End Sub
...
errorsolve:
    ...
    Next
    Form1.Caption = "Asteroids - Score:" + Str$(score) + " Bombs:" + Str$(bombcount) + " Rockets:" + Str$(rocketcount)
